...
// True if the pointer is in an executable memory region (IRAM/IROM). Used to
// validate function pointers handed over by native libs before they are
// stored and later called.
