...
// eeprom_var, EEPROM_VARS and the store/read/erase functions come from
// flash_helper.h - the same ones the native lib interface is wired to, so the
// NVS namespace and key naming live in exactly one place.
